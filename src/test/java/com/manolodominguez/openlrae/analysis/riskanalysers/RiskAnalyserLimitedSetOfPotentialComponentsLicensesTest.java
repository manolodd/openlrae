 ...
 * @author manolodd
 */
class RiskAnalyserLimitedSetOfPotentialComponentsLicensesTest {
    ...
    void testRunAnalyser() {
        ...
        assertEquals(0.4783f, result.getRiskExposure());
        assertTrue(result.getRiskImpact() >= 0.0f);
        assertTrue(result.getRiskImpact() <= 1.0f);
        assertEquals(0.4783f, result.getRiskImpact());
        assertTrue(result.getRiskValue() >= 0.0f);
        assertTrue(result.getRiskValue() <= 1.0f);
        assertEquals(0.2287f, result.getRiskValue());
    }
    
    /**
     * Test of onLanguageChange method, of class RiskAnalyserLimitedSetOfPotentialComponentsLicenses.
     */
    @Test
