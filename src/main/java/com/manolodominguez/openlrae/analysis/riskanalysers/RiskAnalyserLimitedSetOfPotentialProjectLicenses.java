                ...
                switch (compatibility) {
                    ...
                    case FORCED_COMPATIBLE:
                        ...
                        if (this.project.getLicense() != potentialProjectLicense) {
                            rootCauses.add(potentialProjectLicense.getSPDXIdentifier() + " could not be used as project license because of " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") that is forced to be compatible with " + this.project.getLicense().getSPDXIdentifier() + " but perhaps is not compatible with " + potentialProjectLicense.getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
