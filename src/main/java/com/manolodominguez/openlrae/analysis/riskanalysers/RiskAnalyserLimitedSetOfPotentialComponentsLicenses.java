            ...
            for (SupportedLinks potentialLink : SupportedLinks.values()) {
                ...
                switch (compatibility) {
                    ...
                    case UNCOMPATIBLE:
                        ...
                        // project.
                        rootCauses.add("A component under " + potentialComponentLicense.getSPDXIdentifier() + " cannot not be included in " + project.getName() + " " + project.getVersion() + " because it is incompatible with the project license (" + project.getLicense().getSPDXIdentifier() + ") via a " + potentialLink + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    ...
                    case MOSTLY_COMPATIBLE:
                        ...
                        rootCauses.add("A component under " + potentialComponentLicense.getSPDXIdentifier() + " can be included carefully in " + project.getName() + " " + project.getVersion() + " because it is not compatible in a few cases with the project license (" + project.getLicense().getSPDXIdentifier() + ") via a " + potentialLink + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                        warnings.add("Although a component under " + potentialComponentLicense.getSPDXIdentifier() + " can often be included in " + project.getName() + " " + project.getVersion() + " because it is usually compatible with the project license (" + project.getLicense().getSPDXIdentifier() + ") via a " + potentialLink + " link and " + this.project.getRedistribution().toString() + " redistribution, this is not always really true because it depends on your specific case.");
                        tips.add("Try changing the license of the project (" + project.getLicense().getSPDXIdentifier() + ") by another that that allow that components under license " + potentialComponentLicense.getSPDXIdentifier() + " can be included.");
                    ...
                    case MOSTLY_UNCOMPATIBLE:
                        ...
                        rootCauses.add("A component under " + potentialComponentLicense.getSPDXIdentifier() + " should not be included in " + project.getName() + " " + project.getVersion() + " because it is not compatible in most cases with the project license (" + project.getLicense().getSPDXIdentifier() + ") via a " + potentialLink + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                        warnings.add("Although a component under " + potentialComponentLicense.getSPDXIdentifier() + " can be included in " + project.getName() + " " + project.getVersion() + " altough it is not compatible in a few cases with the project license (" + project.getLicense().getSPDXIdentifier() + ") via a " + potentialLink + " link and " + this.project.getRedistribution().toString() + " redistribution, this is not always really true because it depends on your specific case.");
                        tips.add("Try changing the license of the project (" + project.getLicense().getSPDXIdentifier() + ") by another that that allow that components under license " + potentialComponentLicense.getSPDXIdentifier() + " can be included.");
