...
public class RiskAnalyserLicensesOfComponentsIncompatibleWithProjectLicense extends AbstractRiskAnalyser {
    ...
    public void runAnalyser() {
        ...
        for (ComponentBinding componentBinding : this.project.getBillOfComponentBindings()) {
            compatibility = licensesCompatibilities.getCompatibilityOf(componentBinding.getComponent().getLicense(), this.project.getLicenses().get(0), componentBinding.getLinkType(), this.project.getRedistribution());
            switch (compatibility) {
                case COMPATIBLE:
                    ...
                    goodThings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getFullName() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    break;
                case FORCED_COMPATIBLE:
                    ...
                    goodThings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getFullName() + " (because it is forced as compatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution");
                    warnings.add("Although " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getFullName() + " (because it is forced as compatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, it could be a source of risk for project maintenance in the future.");
                    tips.add("Try changing " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") by another component natively compatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    break;
                case UNCOMPATIBLE:
                    ...
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") cannot be included in " + this.project.getFullName() + " (because it is incompatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    tips.add("Try changing " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") by another component compatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution. Also, you could get written permission from the copyright holder of " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " to include it in a project released under " + this.project.getLicenses().get(0).getSPDXIdentifier());
                    break;
                case UNKNOWN:
                ...
                case UNSUPPORTED:
                    ...
                    riskExposure += componentBinding.getWeight().getWeightValue();
                    riskImpact += ((TOTAL_COMPATIBILITY - compatibility.getCompatibilityValue()) * componentBinding.getWeight().getWeightValue());
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") cannot be included in " + this.project.getFullName() + " (because OpenLRAE does not support this license and by default this is handled as uncompatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    warnings.add("Although " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") is handled as incompatible by default because its license is not supported by OpenLRAE, it could be compatible once OpenLRAE knows how to analyse this license. We apologize for the inconvenience.");
                    tips.add("Try changing " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") by another component with a license supported by OpenLRAE and compatible with " + this.project.getLicenses().get(0).getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    break;
                case MOSTLY_COMPATIBLE:
                    ...
                    riskExposure += componentBinding.getWeight().getWeightValue();
                    riskImpact += ((TOTAL_COMPATIBILITY - compatibility.getCompatibilityValue()) * componentBinding.getWeight().getWeightValue());
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getFullName() + " (" + this.project.getLicenses().get(0).getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances.");
                    warnings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getFullName() + " (" + this.project.getLicenses().get(0).getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances. Be sure that in your particular case this inclusion is possible before using the component in the project.");
                    tips.add("Try changing " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") by another component fully compatible with a project licensed under " + this.project.getLicenses().get(0).getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                ...
                case MOSTLY_UNCOMPATIBLE:
                    ...
                    riskExposure += componentBinding.getWeight().getWeightValue();
                    riskImpact += ((TOTAL_COMPATIBILITY - compatibility.getCompatibilityValue()) * componentBinding.getWeight().getWeightValue());
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") should not be included in " + this.project.getFullName() + " (" + this.project.getLicenses().get(0).getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances.");
                    warnings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") should not be included in " + this.project.getFullName() + " (" + this.project.getLicenses().get(0).getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances. Be sure that in your particular case this inclusion is possible before using the component in the project.");
                    tips.add("Try changing " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") by another component fully compatible with a project licensed under " + this.project.getLicenses().get(0).getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    tips.add("Even in the case that in your specific case you can use a component that is not fully compatible with the project license (in general), always is better to use components whose license is fully compatible with the project license under all circumstances.");
                    break;
            }
