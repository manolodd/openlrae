        ...
        for (ComponentBinding componentBinding : this.project.getBillOfComponentBindings()) {
            ...
            switch (compatibility) {
                case COMPATIBLE:
                    ...
                    goodThings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getName() + "-" + this.project.getVersion() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    break;
                case FORCED_COMPATIBLE:
                    ...
                    goodThings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getName() + "-" + this.project.getVersion() + " (because it is forced as compatible with " + this.project.getLicense().getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution");
                    warnings.add("Although " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getName() + "-" + this.project.getVersion() + " (because it is forced as compatible with " + this.project.getLicense().getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, it could be a source of risk for project maintenance in the future.");
                ...
                case UNCOMPATIBLE:
                    ...
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") cannot be included in " + this.project.getName() + "-" + this.project.getVersion() + " (because it is incompatible with " + this.project.getLicense().getSPDXIdentifier() + ", the license of the project) via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                ...
                case MOSTLY_COMPATIBLE:
                    ...
                    riskExposure += componentBinding.getWeight().getWeightValue();
                    riskImpact += ((TOTAL_COMPATIBILITY - compatibility.getCompatibilityValue()) * componentBinding.getWeight().getWeightValue());
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getName() + "-" + this.project.getVersion() + " (" + this.project.getLicense().getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances.");
                    warnings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") can be included in " + this.project.getName() + "-" + this.project.getVersion() + " (" + this.project.getLicense().getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances. Be sure that in your particular case this inclusion is possible before using the component in the project.");
                ...
                case MOSTLY_UNCOMPATIBLE:
                    ...
                    riskExposure += componentBinding.getWeight().getWeightValue();
                    riskImpact += ((TOTAL_COMPATIBILITY - compatibility.getCompatibilityValue()) * componentBinding.getWeight().getWeightValue());
                    rootCauses.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") should not be included in " + this.project.getName() + "-" + this.project.getVersion() + " (" + this.project.getLicense().getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances.");
                    warnings.add(componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") should not be included in " + this.project.getName() + "-" + this.project.getVersion() + " (" + this.project.getLicense().getSPDXIdentifier() + ") via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution, except under certain circumstances. Be sure that in your particular case this inclusion is possible before using the component in the project.");
                    tips.add("Try changing " + componentBinding.getComponent().getName() + "-" + componentBinding.getComponent().getVersion() + " (" + componentBinding.getComponent().getLicense().getSPDXIdentifier() + ") by another component fully compatible with a project licensed under " + this.project.getLicense().getSPDXIdentifier() + " via a " + componentBinding.getLinkType().toString() + " link and " + this.project.getRedistribution().toString() + " redistribution.");
                    tips.add("Even in the case that in your specific case you can use a component that is not fully compatible with the project license (in general), always is better to use components whose license is fully compatible with the project license under all circumstances.");
                    break;
            }
